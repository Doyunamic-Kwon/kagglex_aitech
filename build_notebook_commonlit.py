# -*- coding: utf-8 -*-
"""
commonlit_readability.ipynb 생성 빌더.
재난 트윗(분류)과 달리 이건 '회귀'(reading ease 점수 예측, 평가지표 RMSE)라
구조를 회귀에 맞게 바꿈: 혼동행렬 대신 예측-실제 산점도/잔차, FP·FN 대신 과대·과소예측 사례.
"""
...
with open("commonlit_readability.ipynb", "w", encoding="utf-8") as f:
    nbf.write(nb, f)
print(f"notebook written: commonlit_readability.ipynb  ({len(cells)} cells)")
